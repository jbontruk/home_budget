...
# Directories ----
setwd('C:/Users/jbontruk/Downloads')
budget_file <- "Budżet (1).xlsx"
feed_file_jarek <- 'transactions_export_2024-01-31_jarek.csv'
feed_file_ela <- 'transactions_export_2024-01-31_ela.csv'
...
bud24 <- read.xlsx(xlsxFile = budget_file, sheet = 'budget_2024',
                   rows = c(1:23), cols = c(1:14))
...
bud24 <- gather(bud24, date, amount, `2024-01-01`:`2024-12-01`)

bud <- rbind(bud18, bud19, bud20, bud21, bud22, bud23, bud24) %>%
